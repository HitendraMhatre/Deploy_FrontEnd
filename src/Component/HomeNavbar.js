              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start ml-0">
                ...
                <div className="hidden  sm:block">
                  <div className="flex space-x-22  ">
                    ...
                    <div className='flex space-x-2 justify-end pr-4 ml-96'>
                      <svg class="w-10 ml-66  text-white hover:cursor-pointer first-line:" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" onClick={handlecart}>
...
<div className="px-2 pt-2 pb-3 space-y-1">
  ...
  {!sessionStorage.getItem("email") && <a className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium" onClick={handleLoginClick}>Login</a> }
  {sessionStorage.getItem("email") && <a className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium" onClick={handleLogoutClick}>Logout</a> }
</div>
</Disclosure.Panel>
